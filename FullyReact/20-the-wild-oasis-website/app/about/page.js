...
export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* In the second picture, we don't specify the images as a resource
      (import) this is happen when we get data from databases or apis. In this
      cases we are gonna use this version of ussage. This is also very important
      to do that.  */}
      ...
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium">
          Managed by our familiy since 1962
        </h1>
